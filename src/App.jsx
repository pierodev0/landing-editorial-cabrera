...
function App() {
  ...
  useEffect(() => {
    const parser = new PublicGoogleSheetsParser(
      '1cowr6YtloRNAJQCyV6kp-NHJopQ8-Uq540BufjQlGgU',
    );
  ...
  function handleMessage() {
    ...
    const url = `https://wa.me/996506060?text=${mensaje}`;
  ...
  return (
    <>
      ...
      <main className='mx-auto max-w-5xl px-4 py-8 min-h-[calc(100vh-60px)]  absolute top-[60px] left-0 right-0'>
        <h1 className='text-4xl lg:text-5xl font-extrabold mb-6 text-blue-700 text-center'>
